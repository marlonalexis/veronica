package com.rolandopalermo.facturacion.ec.app.handler;
...
public class RestExceptionHandler extends ResponseEntityExceptionHandler {
	...
	protected ResponseEntity<Object> handleHttpMessageNotReadable(HttpMessageNotReadableException ex, HttpHeaders headers, HttpStatus status, WebRequest request) {
		...
		logger.info(String.format("{} to {}", servletWebRequest.getHttpMethod(), servletWebRequest.getRequest().getServletPath()));
	...
	private ResponseEntity<Object> buildResponseEntity(ApiError apiError) {
		VeronicaResponseDTO<ApiError> error = new VeronicaResponseDTO<>();
		error.setSuccess(false);
		error.setResult(apiError);
